        ...
        children: [
          ...
          GetBuilder<CartController>(builder: (_cartController){
            return _cartController.getItems.length > 0 ?Positioned(
                                    ...
                                    onTap: () {
                                      ...
                                      if(popularIndex >= 0){
                                        ...
                                        if(recommendedIndex < 0 ){
                                          Get.snackbar("History product", "Product review is not available for history cart " ,
                ...
                )):const NoDataPage(text: "", imgPath: "assets/images/empty_cart.png",);
          })
        ],
      ),
